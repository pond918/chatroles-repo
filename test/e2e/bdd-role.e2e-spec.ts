...
import { updateUser as updateSystemUser } from './users.e2e-spec';
...
\`\`\``,
    ...
    const [spec] = await generateBDDCases(testResponses, prdTestResponses);
    const resp = (
